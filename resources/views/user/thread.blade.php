...
<body style="background-color: white">
    ...
    <div class="container" style="margin-top: 100px">
        ...
        <div class="row">
            <div class="col-sm">
                <img class="img-fluid" src="{{asset('template/assets/img/bromo.jpg')}}" style="width:100%; border-radius:5px">
            </div>
            <div class="col-sm">
                <div class="informasi">
                        ...
                        <div class="isi-penilaian">
                            <div class="row">
                                <div class="col text-left">
                                    <img src="assets/img/profil.jpg" style="float:left;margin-right:10px">
                                    <div>
                                        <h5>Arini</h5>
